...
private:
  ...
  struct WorkSettings {
    ...
    unsigned char din_Pi0_invert;                       // 6 Признак инвертирования входов порта Pi0
    unsigned char din_Pi1_invert;                       // 7 Признак инвертирования входов порта Pi1
    unsigned char din_spi_invert[G_CONST::BYTES_RW];    // 8 Признак инвертирования SPI входов 
    unsigned char dout_spi_invert[G_CONST::BYTES_RW];   // 9 Признак инвертирования SPI выходов
