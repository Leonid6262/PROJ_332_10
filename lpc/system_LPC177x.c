...
#define __M                     ((PLL0CFG_Val & 0x1F) + 1)// 10
 ...
 *----------------------------------------------------------------------------*/
unsigned long  SystemCoreClock 	= 	__CORE_CLK;	// System Clock Frequency (Core Clock) 120000000
unsigned long  PeripheralClock 	= 	__PER_CLK; 	// Peripheral Clock Frequency (Pclk) 60000000
unsigned long  EMCClock		= 	__EMC_CLK; 	// EMC Clock Frequency       60000000 
unsigned long  USBClock 	= 	(48000000UL);   // USB Clock Frequency - this value will be updated after call
